...
def _stub_service_mint(monkeypatch):
    ...
    # module wasn't loaded yet -- a seal that silently declines to seal is worse than no
    # seal. See docs/principles/a-stub-that-needs-another-test-is-not-a-stub.md
